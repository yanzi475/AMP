...
const argv = require('yargs')
  ...
  .command('app', 'run hj app in local Chrome (--ios, --android)')
  ...
  .command('dev-srv', 'local API server (-p port || 3002, --nohj)')
  ...
  .command('prod', 'build PROD release and copy to hj-wm-res, PROD only')
